<?php
    ...
    // ----------------------------- モデル
    require_once MODEL_PATH . "Abstract.php";
    require_once MODEL_PATH . "basis/BaseInfo.php";
    require_once MODEL_PATH . "basis/ContentsNewinfo.php";
    require_once MODEL_PATH . "basis/MailHistory.php";
    require_once MODEL_PATH . "basis/MailSetting.php";
    ...
    require_once MODEL_PATH . "system/Log.php";
    require_once MODEL_PATH . "system/Member.php";
