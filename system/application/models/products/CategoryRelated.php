 ...
 * @version    v1.0
 */
class Application_Model_CategoryRelated extends Application_Model_Abstract {

    /**
     * テーブル名
     * @var
     */
    protected $_stTableName = "d_category_related";
    ...
    public function save($arrData) {
        ...
        try {
            ...
            $arrParams = $arrData;
            $arrParams["d_category_related_UpdatedTime"] = date("Y-m-d H:i:s");
            $arrParams["d_category_related_UpdatedByID"] = $this->objAdminSess->MemberID;
            $stWhere = $this->objMasterDb->quoteInto("d_category_related_CategoryRelatedID = ? ", $arrData["d_category_related_CategoryRelatedID"]);
    ...
    public function find($arrWhere, $arrColumn = "") {
        ...
        try {
            ...
            $objSelect->where("d_category_related_DelFlg = ? ", 0);
  ...
  /**
    ...
    public function insert($arrData) {
        ...
        try {
            ...
            $stTable = $this->getTableName();
            $arrParams = $arrData;
            $arrParams["d_category_related_CreatedTime"] = date("Y.m.d H:i:s");
            $arrParams["d_category_related_CreatedByID"] = $this->objAdminSess->MemberID;
            $arrParams["d_category_related_UpdatedByID"] = $this->objAdminSess->MemberID;
            $arrParams["d_category_related_DelFlg"] = "0";
    ...
    public function delete($iID) {
        ...
        try {
            ...
            $stTable = $this->getTableName();
            // 更新内容
            $arrParams["d_category_related_DelFlg"] = 1;
            $arrParams["d_category_related_UpdatedTime"] = date("Y-m-d H:i:s");
            $arrParams["d_category_related_UpdatedByID"] = $this->objAdminSess->MemberID;
            // 更新条件
            $arrWhere["d_category_related_CategoryRelatedID = ?"] = $iID;
            $arrWhere["d_category_related_DelFlg = ?"]  = 0;
