 ...
 * @version    v1.0
 */
class Application_Model_CategoryCount extends Application_Model_Abstract {

    /**
     * テーブル名
     * @var
     */
    protected $_stTableName = "d_category_count";
    ...
    public function save($arrData) {
        ...
        try {
            ...
            $arrParams = $arrData;
            $arrParams["d_category_count_UpdatedTime"] = date("Y-m-d H:i:s");
            $stWhere = $this->objMasterDb->quoteInto("d_category_count_CategoryID = ? ", $arrData["d_category_count_CategoryID"]);
  ...
  /**
    ...
    public function insert($arrData) {
        ...
        try {
            ...
            $stTable = $this->getTableName();
            $arrParams = $arrData;
            $arrParams["d_category_count_CreatedTime"] = date("Y.m.d H:i:s");
    ...
    public function deleteAll() {
        ...
        try {
            ...
            $stTable = $this->getTableName();
            $this->objMasterDb->delete($stTable);
