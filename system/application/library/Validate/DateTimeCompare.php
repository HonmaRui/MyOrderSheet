 ...
 * @version    v1.0
 */
class Validate_DateTimeCompare extends Validate_Abstract {
    /**
     * エラーメッセージ用文章
     * @var array
     */
    protected $_arrMessageTemplates = array(
        "Invalid" => "%ColumnName%は正しい日付範囲で入力して下さい。",
    );
    ...
    public function isValid() {
        try {
            $arrDate = $this->getParam();
            $stDate1 = strtotime($arrDate[0]);
            $stDate2 = strtotime($arrDate[1]);
