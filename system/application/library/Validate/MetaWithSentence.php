 ...
 * @category   ECSite
 * @package    Validate
 * @subpackage MetaWithSentence
 * @copyright  Copyright (c) 2014 Majestic-PIC Co., Ltd.
 * @author     鈴木
 * @version    v1.0
 */
class Validate_MetaWithSentence extends Validate_Abstract {
    /**
     * エラーメッセージ用文章
     * @var array
     */
    protected $_arrMessageTemplates = array(
        "Invalid" => "%ColumnName%に記号が含まれています。記号を削除してから再度送信して下さい。",
    );
    ...
    /**
     * セットされたパラメータにメタ文字が含まれているかチェックする。
     *
     * @access public
     * @return mixed
     */
